...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_walls_rectangular.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hel-band <hel-band@student.1337.ma>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/27 16:22:52 by hel-band          #+#    #+#             */
/*   Updated: 2024/03/27 16:39:20 by hel-band         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_wall(t_map *map)
{
	...
	i = 0;
	while (i < map->lines && map->carte[i][0] == '1'
			&& map->carte[i][map->columns - 1] == '1')
	{
